...
@Data
public class SteelPurchaseFrameContractFormDingTalk implements DingTalkApprovalFormEngine {
    ...
    public ApprovalBusinessTypeEnum getBusinessApprovalTypeEnum() {
        return ApprovalBusinessTypeEnum.STEEL_PURCHASE_FRAME_CONTRACT;
    }
