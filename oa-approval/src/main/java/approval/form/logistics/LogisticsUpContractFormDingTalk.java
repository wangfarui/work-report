...
/**
 * @author xielu
 * @date 2023-10-08 14:51
 */
@Data
public class LogisticsUpContractFormDingTalk implements DingTalkApprovalFormEngine {
    ...
    private String contractType = "承运合同";
    ...
    public ApprovalBusinessTypeEnum getBusinessApprovalTypeEnum() {
        return ApprovalBusinessTypeEnum.LOGISTICS_UP_CONTRACT;
    }
}
